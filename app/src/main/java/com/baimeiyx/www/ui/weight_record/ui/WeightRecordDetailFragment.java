...
public class WeightRecordDetailFragment extends BaseSimpleFragment implements FragmentInteraction {
    ...
    private DialogRulerFragment dialogRulerFragment;
    ...
    private void _init() {
        ...
        adapterBlueToothDevices.setItemOnClickListener(new ItemOnClickListener<BluetoothDevice>() {
            ...
            public void onItemClick(View view, BluetoothDevice data, int poistion) {
                connectBle(data);
                FragmentUtils.showFragmentAddStack(getFragmentManager(), R.id.wr_container, weightBleFragment);
            }
        });
    }
    ...
    private void _initBlueTooth() {
        ...
        if (bluetoothAdapter == null || !bluetoothAdapter.isEnabled()) {
            ToastUtils.showShortToast(getResources().getString(R.string.toast_pelase_open_ble));
            return;
        }
...
//                }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            appViewModel.getObserver().postValue(bleData);
//            weightBleFragment.setWeight(bleData);
    ...
    public void doClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.tv_input_weight:
                dialogRulerFragment.setListener(this);
    ...
    public void fragmentToAcProcess(String data) {
        ...
        bundle.putString(WeightLogFragment.LASTEST_WEIGHT, data);
        FragmentUtils.showFragmentAddStack(getFragmentManager(), R.id.wr_container, WeightLogFragment.newInstance(bundle));
