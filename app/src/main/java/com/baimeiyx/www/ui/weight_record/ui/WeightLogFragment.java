...
public class WeightLogFragment extends BaseSimpleFragment {
    ...
    private void _initAxisXLables() {
        String[] dateX = {"11-01", "11-01", "11-02", "11-03", "11-04", "11-05", "11-06", "11-07", "11-08", "11-09", "11-10", "11-10"};//X轴的标注
    ...
    private void _initAxisPoints() {
        int[] weights = {50, 50, 42, 90, 33, 20, 74, 22, 18, 79, 20, 20};//图表的数据点
