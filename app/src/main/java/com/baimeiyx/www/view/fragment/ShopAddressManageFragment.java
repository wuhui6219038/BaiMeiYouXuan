...
import com.baimeiyx.www.view.adapter.AdapterShopAddress;
...
public class ShopAddressManageFragment extends BaseUserFragment<ShopAddressResult> {
    ...
    private void _initRv() {
        ...
        mAdapterShopAddress.setOnClickListener((data, type) -> {
            if (type == AdapterShopAddress.UPDATE) {
                ...
                FragmentUtils.showFragmentAddStack(getFragmentManager(), R.id.user_contain, ShopAddressFragment.newInstance(bundle));
    ...
    public void onViewClicked(View view) {
        FragmentUtils.showFragmentAddStack(getFragmentManager(), R.id.user_contain, ShopAddressFragment.newInstance());
    }
