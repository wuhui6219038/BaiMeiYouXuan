...
public class UpdateUserInfoFragment extends BaseUserFragment<BaseResult> {
    ...
    private void doConnect() {
        DataManager.getBaiMeiApiService().doUpdateUserInfo(mPath, mPath2, spUtils.getString(SP_SESSION_ID), params)
...
//                doUpdateUserInfo(mPath, mPath2, spUtils.getString(SP_SESSION_ID), params)
//                .observe(this, this);
    }
