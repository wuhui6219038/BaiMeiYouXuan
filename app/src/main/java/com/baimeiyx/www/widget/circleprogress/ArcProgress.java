...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = SizeUtils.sp2px(40);
        default_suffix_text_size = SizeUtils.sp2px(15);
        default_suffix_padding = SizeUtils.dp2px(4);
        default_suffix_text = "%";
        default_bottom_text_size = SizeUtils.sp2px(10);
        default_stroke_width = SizeUtils.dp2px(4);
